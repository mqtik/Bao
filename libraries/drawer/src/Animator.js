...
export default class Animator extends PureComponent {
  ...
  _handlePanResponderRelease = (e, gesture) => {
    console.log("hanndle pan respose!", e, gesture)
    ...
    } else if (gesture.dy > this.props.toggleThreshold && this.props.currentPosition === this.props.middlePosition) {
      this._transitionTo(this.props.middlePosition, this.props.onCollapsed);
      this.props.onDrawerStateSet(MIDDLE_STATE);
